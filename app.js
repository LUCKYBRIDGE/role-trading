...
const scenarios = [
  ...
  },
  {
    ...
    actions: [
      ...
      ["boundary", "상대 지적으로 장면을 바꾸지 않기", "자기 행동을 확인해야 할 순간에 다른 학생을 끌어오는 방식은 허용하지 않는다고 말합니다."],
...
const sentences = [
  ...
  ["observer", null, "지금 한 명의 행동 뒤에 주변 반응이 붙으면서 교실 소리가 커지고 있어요."],
  ["observer", null, "지금 몇몇 시선이 수업 밖으로 이동해 있어요."],
  ["observer", null, "방금까지는 활동이 잘 되고 있었는데, 지금은 멈춘 모둠이 보이네요."],
  ["observer", null, "지금 웃음이 있지만, 수업 흐름은 끊기고 있어요."],
  ...
  ["summarizer", null, "지금 먼저 정리할 것은, 이 행동 뒤에 수업이 멈췄다는 사실입니다."],
  ...
  ["summarizer", null, "짧은 말과 웃음으로 시작됐지만, 지금은 반 전체의 수업 집중이 멈춘 상황입니다."],
  ...
  ["summarizer", null, "지금은 어느 말 뒤에 관계와 수업 흐름이 끊겼는지를 정리하겠습니다."],
  ...
  ["boundary", null, "지금은 다른 이야기로 장면을 바꿀 시간이 아닙니다. 이 행동부터 확인하겠습니다."],
  ...
  ["boundary", null, "그 말은 상대를 불편하게 만들 수 있습니다. 여기서 더 이어가는 것은 허용하지 않겠습니다."],
...
const studyCards = [
  {
    label: "핵심 개념",
    front: "학생이 조용해졌는데도 다음 시간에 같은 행동이 반복된다면?",
    back:
      "행동이 멈춘 것과 역할이 바뀐 것은 다르다. 반복된다면 학생이 새로 들어갈 자리와 행동을 아직 경험하지 못한 것이다.",
    note: "대응: 멈춘 뒤 '이제 무엇을 하면 되는지'를 한 가지 행동으로 제시한다.",
  },
  {
    label: "공식 경계",
    front: "비슷한 장면인데 어제의 개입이 오늘은 통하지 않는다면?",
    back:
      "역할선택 생활교육은 상황별 공식이 아니라 교사의 위치 선택이다. 관계, 집단 반응, 교사의 감정, 흐름에 따라 첫 자리가 달라진다.",
    note: "대응: 먼저 볼 것을 하나 정한다. 행동, 관계, 흐름, 기준 중 무엇을 먼저 세울지 선택한다.",
  },
  {
    label: "역할",
    front: "지적받은 학생이 웃어넘기고 주변 시선이 모인다면?",
    back:
      "그 웃음은 성격이라기보다 덜 다치고 장면을 바꿔온 방식일 수 있다. 이해하되, 지금 교실에서 그 방식이 계속 작동하게 두지는 않는다.",
    note: "대응: '웃음으로 넘기지 말고, 지금은 네 행동 하나만 확인하자'처럼 장면을 좁힌다.",
  },
  {
    label: "유연함",
    front: "나는 친절하게 설명했는데도 아이들이 더 흔들린다면?",
    back:
      "설명이 나쁜 것이 아니라 설명자 역할에 고착되었을 수 있다. 잘함은 같은 방식을 더 강하게 쓰는 것이 아니라 필요한 자리로 이동하는 것이다.",
    note: "대응: 설명을 추가하기 전, 관찰 문장 하나나 경계 문장 하나로 교사의 위치를 바꾼다.",
  },
  {
    label: "텔레",
    front: "엎드린 학생을 보는 순간 '또 반항이네'가 먼저 올라온다면?",
    back:
      "텔레가 약해진 신호일 수 있다. 이 행동을 내 수업에 대한 평가로 받으면 교사는 빨리 소진되고, 학생은 다시 고정된 역할로 보인다.",
    note: "대응: 반항으로 단정하기 전 패턴을 보고, 짧게 접촉하거나 수업 뒤 따로 확인한다.",
  },
  {
    label: "깨진 텔레",
    front: "학생은 또 엎드리고, 나는 또 깨우고, 둘 다 지친다면?",
    back:
      "깨진 텔레에서는 학생도 교사도 같은 역할을 반복한다. 학생은 '늘 그런 아이', 교사는 '늘 다그치는 사람'으로 굳어진다.",
    note: "대응: 같은 반응을 반복하기 전에 3초 멈추고, 관찰하기·짧게 터치하기·수업 뒤 확인하기 중 하나를 고른다.",
  },
  {
    label: "학생의 자동반응",
    front: "지적받은 학생이 바로 '쟤도 했는데요?'라고 말한다면?",
    back:
      "그 말은 단순 반박이 아니라 체면을 지키는 자동반응일 수 있다. 교사가 그 말에 끌려가면 장면은 행동 수정이 아니라 힘겨루기로 바뀐다.",
    note: "대응: '다른 친구 이야기는 뒤에 확인하고, 지금은 네 행동 하나만 보자'로 좁힌다.",
  },
  {
    label: "역할 전환",
    front: "발표를 피하는 아이에게 '다음엔 잘해'라고 말해도 바뀌지 않는다면?",
    back:
      "역할은 통째로 바뀌지 않는다. 피하는 아이에게 필요한 것은 의지 요구가 아니라 감당 가능한 작은 역할 경험이다.",
    note: "대응: '첫 문장만 읽기', '친구 말 뒤에 한 문장 보태기'처럼 가장 쉬운 한 행동부터 정한다.",
  },
  {
    label: "관찰자",
    front: "뒤쪽 대화가 번질 때 바로 이름을 부르고 싶어진다면?",
    back:
      "이름을 부르는 순간 장면이 교사와 그 학생의 문제로 좁아질 수 있다. 관찰자는 학생을 공격하지 않고 흐름을 먼저 드러낸다.",
    note: "대응: '지금 뒤쪽 대화가 이어지면서 앞쪽 시선도 흔들리고 있어요.'",
  },
  {
    label: "사건 정리자",
    front: "장난이었는지 따지는 사이 수업 흐름이 더 끊긴다면?",
    back:
      "사건 정리자는 의도 재판을 서두르지 않고, 무엇이 끊겼는지를 먼저 정의한다. 학생을 판정하지 않고 사건의 영향을 다룬다.",
    note: "대응: '장난인지보다 지금 발표가 멈춘 상황을 먼저 정리하겠습니다.'",
  },
  {
    label: "경계 설정자",
    front: "낮추는 말이 나오자 화가 먼저 올라오는 순간이라면?",
    back:
      "경계 설정은 화내기가 아니다. 교사는 자기 감정이 아니라 공동체 기준을 대표해 허용되지 않는 선과 돌아올 길을 함께 말한다.",
    note: "대응: '친구를 낮추는 말은 여기서 멈춥니다. 다시 수업으로 돌아옵니다.'",
  },
  {
    label: "시스템 연결자",
    front: "질문이 계속 끼어들어 설명이 매번 끊긴다면?",
    back:
      "학생 의지만의 문제가 아닐 수 있다. 질문이 들어올 자리가 없으면 질문은 계속 끼어든다. 시스템 연결자는 학생을 탓하기보다 구조를 조정한다.",
    note: "대응: 질문은 칠판에 적고, 설명 뒤 5분 동안 확인하는 자리로 옮긴다.",
  },
  {
    label: "회피와 유연함",
    front: "오늘은 그냥 넘어가자고 했는데 마음이 계속 찝찝하다면?",
    back:
      "유연함은 보고 선택해서 넘기는 것이고, 회피는 불편해서 못 본 척하는 것이다. 회피가 반복되면 교실 기준은 더 흐려진다.",
    note: "대응: 작게라도 사실 하나와 기준 하나를 말한다. '지금 웃음이 커졌고, 낮추는 말은 멈춥니다.'",
  },
  {
    label: "사과와 회복",
    front: "미안해, 괜찮아까지 했는데 다음 날 같은 일이 반복된다면?",
    back:
      "사과 절차는 끝났지만 역할 전환은 일어나지 않은 것이다. 회복은 감정 문장으로 끝나지 않고 다음 행동 선택으로 이어져야 한다.",
    note: "대응: 무엇이 미안한지 확인하고, '다음에는 친구 말이 끝나기 전에 끼어들지 않겠습니다'까지 붙인다.",
  },
];
...
function renderStudyCard() {
  ...
  const faceHint = isBack ? "이해와 대응" : "교실 장면";
  $("#study-card").innerHTML = `
    ...
    <p>${isBack ? card.note : "이 장면에서 교사의 자동반응이 어디로 향하는지 먼저 떠올려 보세요."}</p>
  `;
...
function selectSimulationResponse(responseId) {
  ...
  $("#quiz-feedback").className = `feedback is-visible ${selected.id === "role-choice" ? "" : "is-warning"}`;
...
function responseOptionsForScenario(scenario, roleId) {
  ...
  return [
    {
      id: "role-choice",
      title: "장면을 보고 역할을 선택한다",
      text: `${action.title}에서 시작해 본다.`,
      feedback: "감정이 개입 위치를 대신 정하게 두지 않고, 지금 장면에서 어떤 자리에 설지 선택해 보는 반응입니다.",
      action,
      sentence,
    },
    {
      ...
      text: controlText,
      feedback:
        "행동을 즉시 멈추려는 반응입니다. 다만 교사의 압박과 학생의 방어가 반복되면 역할 자체는 그대로 남기 쉽습니다.",
      action,
      sentence,
    },
    {
      ...
      text: avoidText,
      feedback:
        "당장의 갈등을 줄이는 반응입니다. 그러나 기준과 작은 전환점이 사라지면 같은 상황이 반복될 수 있습니다.",
      action,
      sentence,
    },
  ];
...
function renderScenarioLenses(scenario) {
  ...
  const automatic = "바로 지목하거나 못 본 척하며 장면을 빠르게 끝내고 싶어질 수 있습니다.";
  return `
    <div class="lens-item">
